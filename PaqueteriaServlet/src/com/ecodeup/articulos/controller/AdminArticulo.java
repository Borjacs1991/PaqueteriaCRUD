	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			case "mostrar":
				...
				break;
			case "enviarubicacion":
				enviarubicacion(request, response);
				break;
			case "showedit":
...
//				break;
	...
	private void enviarubicacion(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException{
		//mostrar(request, response);
		RequestDispatcher dispatcher= request.getRequestDispatcher("/vista/maps.jsp");
		dispatcher.forward(request, response);
	}
